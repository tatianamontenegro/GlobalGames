...
namespace GlobalGames.Controllers
{
    public class OrcamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Mensagem")] Orcamento orcamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Mensagem")] Orcamento orcamento)
        {
            if (id != orcamento.Id)
            {
                return NotFound();
