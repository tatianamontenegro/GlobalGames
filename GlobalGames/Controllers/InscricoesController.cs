...
namespace GlobalGames.Controllers
{
    public class InscricoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Apelido,Morada,Localidade,Cc,DataNascimento")] Inscricao inscricao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Apelido,Morada,Localidade,Cc,DataNascimento")] Inscricao inscricao)
        {
            if (id != inscricao.Id)
            {
                return NotFound();
